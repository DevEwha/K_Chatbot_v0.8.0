...
WEIGHT_NAMING_PATTERNS: Dict[str, WeightNamingPattern] = {
    ...
    "phi3": WeightNamingPattern(
        qkv_weights=["qkv_proj"],
        qkv_fused_name="qkv_proj",
    ...
    "phi3small": WeightNamingPattern(
        # Phi-3-small uses pre-fused QKV projection.
        qkv_weights=["query_key_value"],
...
LAYER_CLASS_MAPPING: Dict[str, Dict[str, str]] = {
    ...
    "phi3": {
        # In this local vLLM tree, Phi-3 inherits from LlamaForCausalLM and
        # reuses LlamaDecoderLayer rather than defining Phi3DecoderLayer.
        "module": "vllm.model_executor.models.llama",
        "v1_module": "vllm.v1.model_executor.models.llama",
        "layer_class": "LlamaDecoderLayer",
    },
    "phi3small": {
        "module": "vllm.model_executor.models.phi3_small",
        "v1_module": "vllm.v1.model_executor.models.phi3_small",
        "layer_class": "Phi3SmallDecoderLayer",
    },
    "gpt2": {
...
MODEL_ALIASES: Dict[str, str] = {
    ...
    "phi-2": "phi",
    "phi-3": "phi3",
    "phi3-small": "phi3small",
    "phi-3-small": "phi3small",
}
